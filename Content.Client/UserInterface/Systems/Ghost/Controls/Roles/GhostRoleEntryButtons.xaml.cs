...
public sealed partial class GhostRoleEntryButtons : BoxContainer
{
    ...
    private void UpdateFollowButton(GhostRoleInfo ghostRoleInfo)
    {
        var canFollow = _cfg.GetCVar(CCVars.GhostRoleFollowEnabled) && ghostRoleInfo.AllowFollow;

        if (canFollow)
            return;

        FollowButton.Visible = false;
        RequestButton.RemoveStyleClass("OpenRight");
    }
    // Exodus-end
